...
Initial commit to establish the main branch with the current project files.

# Versatile Landing, Blog & Docs Template for a Simplified Web Presence

![tresorajdir](https://github.com/mryoshq/tresorajdir/assets/125820963/cdf299bd-414a-4a2d-baf0-d188bb4709c7)

tresorajdir is an **open-source template** designed for quick and efficient web project setup, blending **minimalism with functionality**. Whether you're showcasing a portfolio, launching a company landing page, or running a blog, tresorajdir provides everything you need. By combining the power of the [Astro](https://astro.build/), [Tailwind CSS](https://tailwindcss.com/), and [Preline UI](https://preline.co/), this template offers a functional and aesthetically pleasing solution for your web presence.

<p align="left">
    <a href="https://tresorajdir.com" target="_blank">
      <img src="https://vyclk3sx0z.ufs.sh/f/hv6ttNERWpXu6c2AP0GCBnYt4h3FbsMuKyP5RxQ21HvzIae0" alt="tresorajdir Demo" width="180"/></a>
  &nbsp;&nbsp;&nbsp;
    <a href="https://atemplate.com/item/tresorajdir" target="_blank">
      <img src="https://atemplate.com/badages-awards.svg" alt="tresorajdir | A template" width="180"/></a>
</p>

## Table of Contents

* [Why Choose tresorajdir?](#why-choose-tresorajdir)
...
* [x] **Internationalization (i18n) Features**:
  ...
  * Developers can access the monolingual version directly from [`monolingual-site` branch](https://github.com/mryoshq/tresorajdir/tree/monolingual-site).
...
> [!NOTE]
> Currently, there are no planned improvements or known bugs. If you encounter any issues, please report them on our [issues page](https://github.com/mryoshq/tresorajdir/issues) or [start a discussion](https://github.com/mryoshq/tresorajdir/discussions/new/choose) to share ideas, suggestions, or ask questions.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmryoshq%2Ftresorajdir)

### Deploying to Netlify

Click the button below to start deploying your project on Netlify:  

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/mryoshq/tresorajdir)

## Project Structure

tresorajdir organizes modular components, content, and layouts to streamline development and content management.
...
tresorajdir allows for easy customization to suit your specific needs. Here are a couple of ways you can configure components and content:
...
const subTitle: string =
  "At tresorajdir, we tackle the unique challenges encountered in the hardware and construction sectors.";
```
...
export const navBarLinks: NavLink[] = [
  { name: "Home", url: "/" },
  { name: "Sustainability", url: "/products" },
  { name: "Orchard", url: "/orchard" },
...
![tresorajdir MegaMenu](https://github.com/user-attachments/assets/690482af-f1a4-4ebf-be58-eca0b5862973)
...
tresorajdir is now equipped with Starlight, designed to elevate the user experience with documentation. This modern and elegant theme includes a suite of features to make content more accessible and enjoyable to navigate.
...
The SEO Configuration in the tresorajdir template is designed to empower users in optimizing their website's visibility on search engines and social media platforms. This documentation outlines the implementation details and usage instructions for effectively managing SEO settings.
...
This project is released under the MIT License. Please read the [LICENSE](https://github.com/mryoshq/tresorajdir/blob/main/LICENSE) file for more details.
