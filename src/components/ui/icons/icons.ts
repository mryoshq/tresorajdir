export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-red-700 dark:fill-red-500",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill- dark:fill-neutral-300 dark:hs-tab-active:fill-red-500 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text- dark:text-neutral-300 dark:hs-tab-active:text-red-500 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 shrink-0 text- dark:text-red-500",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text- dark:group-hover:text-",
      },
    ],
  ...
  quotation: {
    ...
    class:
      "absolute start-0 top-0 h-16 w-16 -translate-x-6 -translate-y-8 transform text-green-900/20 dark:text-green-100/20",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
